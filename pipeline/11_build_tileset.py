...
Usage:
    .venv/bin/python pipeline/11_build_tileset.py --sample   # Manhattan dev sample
    .venv/bin/python pipeline/11_build_tileset.py            # full citywide
"""
import argparse
import gzip
import json
...
# see pipeline/08_validate.py. Deliberately unit-level, not building-level:
...
# not PLUTO's 2-letter code -- same mapping as 06_build_effective_rates.py's
